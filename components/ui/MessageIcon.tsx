...
export default function MessageIcon({ width = 52, height = 45 }: MessageIconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 52 45" fill="none">
      ...
      <G filter="url(#filter1_d_3_7213)">
        <Rect x="31" y="2" width="15" height="15" rx="7.5" fill="#E82C13" fillOpacity="0.9" />
        <Path d="M38.6699 12.3413H39.6543V6H38.6699L37 7.18652V8.15332L38.5952 7.01514H38.6699V12.3413Z" fill="white"/>
      </G>
      <Defs>
        <LinearGradient id="paint0_linear_3_7213" x1="26" y1="14.4617" x2="41.8085" y2="37.5515" gradientUnits="userSpaceOnUse">
          <Stop stopColor="#F0D399"/>
          <Stop offset="1" stopColor="#D9A846"/>
        </LinearGradient>
        <LinearGradient id="paint1_linear_3_7213" x1="26" y1="7.76563" x2="38.3343" y2="29.1859" gradientUnits="userSpaceOnUse">
          <Stop stopColor="#F0D399"/>
          <Stop offset="1" stopColor="#D9A846"/>
        </LinearGradient>
      </Defs>
